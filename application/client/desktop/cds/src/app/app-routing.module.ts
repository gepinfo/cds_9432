...
{ path : 'studentcreate', loadChildren: () => import('./studentcreate/studentcreate.module').then(m => m.StudentcreateModule), canActivate: [AuthGuard] } , 
{ path : 'studentgetall', loadChildren: () => import('./studentgetall/studentgetall.module').then(m => m.StudentgetallModule), canActivate: [AuthGuard] } , 
];
